...
func TestParsedCredentialAssertionData_Verify(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := p.Verify(tt.args.storedChallenge.String(), tt.args.relyingPartyID, tt.args.relyingPartyOrigin, nil, TopOriginIgnoreVerificationMode, "", false, tt.args.verifyUser, false, tt.args.credentialBytes); (err != nil) != tt.wantErr {
